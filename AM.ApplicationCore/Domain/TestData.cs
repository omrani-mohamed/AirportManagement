...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        public static Staff hostess2 = new Staff { FullName = new FullName { FirstName = "hosstes2", LastName = "hostess2" }, EmailAdress = "hostess2.hostess2@gmail.com", BirthDate = new DateTime(1996, 01, 01), EmploymentDate = new DateTime(2020, 01, 01), Salary = 999 };
        // Travellers
        public static Traveller traveller1 = new Traveller { FullName = new FullName { FirstName = "traveller1", LastName = "traveller1" }, EmailAdress = "traveller1.traveller1@gmail.com", BirthDate = new DateTime(1980, 01, 01), HealthInformation = "no troubles", Nationality = "American" , PassportNumber="1234567",TelNumber="29227604"};
        public static Traveller traveller2 = new Traveller { FullName = new FullName { FirstName = "traveller2", LastName = "traveller2" }, EmailAdress = "traveller2.traveller2@gmail.com", BirthDate = new DateTime(1981, 01, 01), HealthInformation = "Some troubles", Nationality = "French", PassportNumber="1234568" ,TelNumber = "29227604" };
